      ...
      <div className="mx-auto max-w-container px-gutter md:px-gutter-lg">
        ...
        <ul className="mt-14 grid list-none items-start gap-x-12 gap-y-10 p-0 md:mt-20 lg:grid-cols-2">
          ...
          >
            ...
            <p>
              Стены собраны из доски с лунным пазом: каждая доска входит в соседнюю плотно, как в
              замок. Стыки без щелей, доски не расходятся, конопатить ничего не нужно. Паз смотрит
              вниз — вода стекает по стене и не попадает в стык.
            </p>
          </AdvantageItem>
