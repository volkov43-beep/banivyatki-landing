 ...
 * Внутренний контур: пол 2300 мм на всю ширину (x 35..265) на y = 272,
 * стенки до y = 170, выше — полукруг r = 115.
 */
function Horseshoe({ markerId }) {
  return (
    <>
      ...
      <path d="M35,272 V170 A115,115 0 0 1 265,170 V272 Z" {...contour} />
      ...
      {/* Пол 2300 мм — снизу, accent */}
      <Thin x1="35" y1="283" x2="35" y2="302" />
      <Thin x1="265" y1="283" x2="265" y2="302" />
      <Thin x1="35" y1="298" x2="265" y2="298" arrows markerId={markerId} />
      <Label x="150" y="318">
        пол 2300 мм
      </Label>
    </>
  ...
  return (
    <div className="grid gap-12 min-[720px]:grid-cols-2 min-[720px]:gap-x-12">
      ...
      <Figure
        ...
        desc="Арка шириной 2400 мм и высотой 2300 мм с прямыми стенками. Прямой пол шириной 2300 мм на всю ширину."
      >
